  ...
  theme: {
    ...
    semanticTokens: {
      colors: {
        ...
        "bg.canvas": { value: { base: "#FAFAFA", _dark: "#111111" } },
        "bg.surface": { value: { base: "#FFFFFF", _dark: "#1A202C" } },
        "fg.default": { value: { base: "#18181B", _dark: "#FAFAFA" } },
        "fg.muted": { value: { base: "#71717A", _dark: "#A1A1AA" } },
      },
    },
  },
});
