  ...
  const posts = await Promise.all([
    prisma.post.create({
      data: {
        ...
        locationReveal: new Date("2024-10-15T13:00:00Z"),
        userId: users[0].id,
        volunteersNeeded: 1,
        volunteersAlready: 0,
    ...
    prisma.post.create({
      data: {
        ...
        locationReveal: new Date("2024-10-16T15:30:00Z"),
        userId: users[1].id,
        volunteersNeeded: 1,
        volunteersAlready: 0,
        status: PostStatus.OPEN,
    ...
    prisma.post.create({
      data: {
        ...
        locationReveal: new Date("2024-10-17T09:00:00Z"),
        userId: users[2].id,
        volunteersNeeded: 3,
        volunteersAlready: 0,
        status: PostStatus.OPEN,
    ...
    prisma.post.create({
      data: {
        ...
        locationReveal: new Date("2024-10-18T12:00:00Z"),
        userId: users[3].id,
        volunteersNeeded: 1,
        volunteersAlready: 0,
        status: PostStatus.OPEN,
    ...
    prisma.post.create({
      data: {
        ...
        locationReveal: new Date("2024-10-19T10:00:00Z"),
        userId: users[4].id,
        volunteersNeeded: 2,
        volunteersAlready: 0,
